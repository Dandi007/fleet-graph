...
class RunArtifacts:
    ...
    def write_terminal(
        ...
        *consumed* at its last coordinator round -- never the revision current
        at the moment the terminal is written. It is a mechanical hash, never
        prose, and it is optional: a terminal written without a consumed
        ...
        and fails open rather than locking the line (G1 parking semantics).
        """
        event = {
            "run_id": self.run_id,
            "folder_id": self.folder_id,
