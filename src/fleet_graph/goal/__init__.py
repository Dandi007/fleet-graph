...
registered as ``fleet-graph-goal``): the ``goal_enroll`` tool, the ``goal-open``
briefing prompt, and the ``fleet-graph://goal-open/briefing`` resource live
here -- not on the dev-dispatch surface. dd (:5610) is pure dev-dispatch.
"""
