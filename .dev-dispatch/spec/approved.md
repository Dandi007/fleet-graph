...
> 重派注记（v2，2026-09-05 02:3x）：本单取代 dev-fg-5af16702b3c4——前单准入时 dispatched_by 误传空串（M2「决定者必须是派单者」身份绑定断裂，gate 无法合法释放），实现内容相对前单零变化。目标分支 release/wf-4601c8，base=99103be319027c6b2cfa38eb0769f2d0be04c0dc（R0 合流头，派单前 ls-remote 实读）。
